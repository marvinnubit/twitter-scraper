...
[![Go Reference](https://pkg.go.dev/badge/github.com/marvinnubit/twitter-scraper.svg)](https://pkg.go.dev/github.com/marvinnubit/twitter-scraper)
...
```shell
go get -u github.com/marvinnubit/twitter-scraper
```
...
import (
    "context"
    "fmt"
    twitterscraper "github.com/marvinnubit/twitter-scraper"
)
